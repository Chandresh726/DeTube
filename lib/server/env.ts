...
export const STATEMENT_DEFAULT_TAKE = 10;
...
export const MAX_THUMBNAIL_BYTES = 10 * 1024 * 1024; // 10 MiB
export const MAX_CHANNEL_LOGO_BYTES = 10 * 1024 * 1024; // 10 MiB
...
export const RATE_LIMIT_MAX_READ = 120;
export const RATE_LIMIT_MAX_VIEW = 30;
