    ...
    if (session) {
        ...
        return (
            <div className="flex items-center gap-1">
                <Button asChild variant="ghost" size="icon" className="hidden text-destructive md:inline-flex" aria-label="Upload video">
                    <Link href="/uploadVideo"><MdUpload className="size-7" aria-hidden /></Link>
                </Button>
                <ThemeToggle />
