            ...
            <div className="flex flex-col gap-4 md:flex-row">
              <Field>
                ...
                <div className="relative aspect-video overflow-hidden rounded-xl border md:w-96">
                  ...
                  <label
                    ...
                    className="absolute inset-0 flex cursor-pointer items-center justify-center bg-background/60 text-sm font-medium hover:bg-background/80"
                  >
                    <Input
                      id="upload-thumbnail"
                      type="file"
              ...
              <div className="flex w-full flex-col gap-4">
                <Field>
                  ...
                  <Input id="upload-video" type="file" accept="video/*" onChange={handleVideoChange} />
